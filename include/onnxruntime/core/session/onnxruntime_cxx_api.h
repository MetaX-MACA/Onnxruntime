...
struct SessionOptions : Base<OrtSessionOptions> {
  ...
  SessionOptions& AppendExecutionProvider_MACA(const OrtMACAProviderOptions& provider_options); ///< Wraps OrtApi::SessionOptionsAppendExecutionProvider_MACA
...
struct CustomOpApi {
  ...
  OrtValue* KernelContext_GetOriOutput(OrtKernelContext* context, _In_ size_t index);
...
struct CustomOpBase : OrtCustomOp {
  CustomOpBase() {
    ...
    OrtCustomOp::GetInputDataLayout = [](const OrtCustomOp* this_, size_t index) { return static_cast<const TOp*>(this_)->GetInputDataLayout(index); };


    OrtCustomOp::GetOutputTypeCount = [](const OrtCustomOp* this_) { return static_cast<const TOp*>(this_)->GetOutputTypeCount(); };
    OrtCustomOp::GetOutputType = [](const OrtCustomOp* this_, size_t index) { return static_cast<const TOp*>(this_)->GetOutputType(index); };
    OrtCustomOp::GetOutputDataLayout = [](const OrtCustomOp* this_, size_t index) { return static_cast<const TOp*>(this_)->GetOutputDataLayout(index); };
...
#pragma warning(pop)
  ...
  OrtDataLayout GetInputDataLayout(size_t /*index*/) const {return OrtDataLayout::NCHW;}
  OrtDataLayout GetOutputDataLayout(size_t /*index*/) const {return OrtDataLayout::NCHW;}
