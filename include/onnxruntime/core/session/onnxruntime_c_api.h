...
/* \brief MACA Provider Options
*
* \see OrtApi::SessionOptionsAppendExecutionProvider_MACA
*/
typedef struct OrtMACAProviderOptions {
#ifdef __cplusplus
  OrtMACAProviderOptions() : device_id{}, gpu_mem_limit{SIZE_MAX}, arena_extend_strategy{}, do_copy_in_default_stream{1}, has_user_compute_stream{}, user_compute_stream{},  default_memory_arena_cfg{} {}
#endif

  /** \brief MACA device Id
  *   Defaults to 0.
  */
  int device_id;

  /** \brief MACA memory limit (To use all possible memory pass in maximum size_t)
  *   Defaults to SIZE_MAX.
  *   \note If a ::OrtArenaCfg has been applied, it will override this field
  */
  size_t gpu_mem_limit;
  ...
  */
  ...
  /** \brief MACA memory arena configuration parameters
  */
  OrtArenaCfg* default_memory_arena_cfg;

} OrtMACAProviderOptions;
...
struct OrtApi {
  ...
  * \see ::OrtCustomOp
  */
  ORT_API2_STATUS(KernelContext_GetOriOutput, _Inout_ OrtKernelContext* context, _In_ size_t index, _Outptr_ OrtValue** out);
  ...
  */
  ...
  ORT_API2_STATUS(SessionOptionsAppendExecutionProvider_MACA,
                  _In_ OrtSessionOptions* options,
                  _In_ const OrtMACAProviderOptions* maca_options);
...
struct OrtCustomOp {
  ...
  OrtDataLayout(ORT_API_CALL* GetInputDataLayout)(_In_ const struct OrtCustomOp* op, _In_ size_t index);

  ONNXTensorElementDataType(ORT_API_CALL* GetOutputType)(_In_ const struct OrtCustomOp* op, _In_ size_t index);
  size_t(ORT_API_CALL* GetOutputTypeCount)(_In_ const struct OrtCustomOp* op);
  OrtDataLayout(ORT_API_CALL* GetOutputDataLayout)(_In_ const struct OrtCustomOp* op, _In_ size_t index);
...
ORT_API_STATUS(OrtSessionOptionsAppendExecutionProvider_MACA, _In_ OrtSessionOptions* options, _In_ const OrtMACAProviderOptions* maca_options);
