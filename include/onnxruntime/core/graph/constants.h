...
constexpr const char* kMetaxDomain = "com.metax-tech";
...
// constexpr const char* kCudaExecutionProvider = "MACAExecutionProvider";
constexpr const char* kMacaExecutionProvider = "MACAExecutionProvider";
