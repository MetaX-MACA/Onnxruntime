...
OBSERVER_KL_COMPUTING_DEVICE = 'cuda'
...
COMPUTING_OP = {'Conv', 'Gemm', 'ConvTranspose', 'MatMul', 'Attention', 'PPQBiasFusedMatMul', 'ConvActEleActFused', 'MultiHeadAttentionV1'}
