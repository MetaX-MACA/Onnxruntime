...
def format_graph(graph: BaseGraph) -> BaseGraph:
    ...
    # TODO: extra format 
    # formatter(GraphCommand(GraphCommandType.FUSE_GEMM))
    formatter(GraphCommand(GraphCommandType.FUSE_CONV_MUL))
    formatter(GraphCommand(GraphCommandType.FUSE_LAYERNORM))
