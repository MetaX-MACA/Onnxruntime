...
// TODO remove deprecated global config
extern bool do_copy_in_default_stream;
extern onnxruntime::MACAExecutionProviderExternalAllocatorInfo external_allocator_info;
extern onnxruntime::ArenaExtendStrategy arena_extend_strategy;
}  // namespace python
}  // namespace onnxruntime
#endif
...
std::shared_ptr<IExecutionProviderFactory> CreateExecutionProviderFactory_MACA(const OrtMACAProviderOptions& params);
