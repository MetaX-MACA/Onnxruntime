...
ORT_API_STATUS_IMPL(KernelContext_GetOriOutput, _Inout_ OrtKernelContext* context, _In_ size_t index, _Out_ OrtValue** out);
...
ORT_API_STATUS_IMPL(SessionOptionsAppendExecutionProvider_MACA,
