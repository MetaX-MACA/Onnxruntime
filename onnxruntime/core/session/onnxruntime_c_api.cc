...
static constexpr OrtApi ort_api_1_to_12 = {
    ...
    &OrtApis::KernelContext_GetOriOutput,
    ...
    &OrtApis::SessionOptionsAppendExecutionProvider_MACA,
...
static_assert(offsetof(OrtApi, GetSparseTensorIndices) / sizeof(void*) == 192, "Size of version 9 API cannot change");
static_assert(offsetof(OrtApi, SynchronizeBoundOutputs) / sizeof(void*) == 204, "Size of version 10 API cannot change");
