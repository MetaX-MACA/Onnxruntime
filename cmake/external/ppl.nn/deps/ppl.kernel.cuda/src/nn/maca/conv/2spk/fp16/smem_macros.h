...
#define READ_sUv1_SIZE4(_reg, _reg_off, _sm_base_v1, _sUv1_read) \
    {                                                            \
        _reg[_reg_off + 0] = _sm_base_v1[_sUv1_read];            \
        _reg[_reg_off + 1] = _sm_base_v1[_sUv1_read + 8 * 32];   \
        _reg[_reg_off + 2] = _sm_base_v1[_sUv1_read + 16 * 32];  \
        _reg[_reg_off + 3] = _sm_base_v1[_sUv1_read + 24 * 32];  \
    }
