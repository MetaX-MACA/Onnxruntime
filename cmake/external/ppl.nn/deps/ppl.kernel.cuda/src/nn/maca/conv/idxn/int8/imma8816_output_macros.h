...
inline static __device__ int cvtPackSatS8(const int &a, const int &b,const int& c)
{
    typedef union {
        int i;
        signed char c[4];
    ...
    byte ta;
    ta.i = a < -128 ? -128 : a;
    ta.i = ta.i > 127 ? 127 : ta.i;

    byte tb;
    tb.i = b < -128 ? -128 : b;
    tb.i = tb.i > 127 ? 127 : tb.i;
...
#define PACK_V2(_C, _Cv1_off)                                                   \
    {                                                                           \
        _C[_Cv1_off + 0] = cvtPackSatS8(_C[_Cv1_off + 1], _C[_Cv1_off + 0], 0); \
    }

#define PACK_V4(_C, _Cv1_off)                                                                  \
    {                                                                                          \
        _C[_Cv1_off + 2] = cvtPackSatS8(_C[_Cv1_off + 3], _C[_Cv1_off + 2], 0);                \
        _C[_Cv1_off + 0] = cvtPackSatS8(_C[_Cv1_off + 1], _C[_Cv1_off + 0], _C[_Cv1_off + 2]); \
    }
