...
#define READ_sUv1_SIZE2(_reg, _reg_off, _sm_base_v1, _sUv1_read)               \
    {                                                                          \
        _reg[_reg_off]     = _sm_base_v1[_sUv1_read];                          \
        _reg[_reg_off + 1] = _sm_base_v1[_sUv1_read + 16 * TILE_K_V4_PER_CTA]; \
    }

#define READ_sUv1_SIZE4(_reg, _reg_off, _sm_base_v1, _sUv1_read) \
    {                                                            \
        _reg[_reg_off]     = _sm_base_v1[_sUv1_read];            \
        _reg[_reg_off + 1] = _sm_base_v1[_sUv1_read + 8 * 16];   \
        _reg[_reg_off + 2] = _sm_base_v1[_sUv1_read + 16 * 16];  \
        _reg[_reg_off + 3] = _sm_base_v1[_sUv1_read + 24 * 16];  \
    }
...
#define REG_sBv1_SIZE   (TILE_N_V4_PER_THD)
#endif
