...
#pragma unroll
    ...
    const int offset  = (local_tid / 4) * TILE_K_V2_PER_CTA + ((local_tid & 0x3) ^ (local_tid / 16 * 4));
    sAv1_read         = warp_idy * TILE_M_PER_WARP * TILE_K_V2_PER_CTA + offset;
    sBv1_read         = warp_idx * TILE_N_PER_WARP * TILE_K_V2_PER_CTA + SM_A_V1_1BUF * BUF_NUM + offset;
...
#pragma unroll
    ...
    {
        shfl_maca2cuda_sync(C[idx], C[idx + TILE_M_V2_PER_THD], C[idx], C[idx + TILE_M_V2_PER_THD]);
        shfl_maca2cuda_sync(C[idx + 16], C[idx + TILE_M_V2_PER_THD + 16], C[idx + 16], C[idx + TILE_M_V2_PER_THD + 16]);
        shfl_maca2cuda_sync(C[idx + 32], C[idx + TILE_M_V2_PER_THD + 32], C[idx + 32], C[idx + TILE_M_V2_PER_THD + 32]);
        shfl_maca2cuda_sync(C[idx + 48], C[idx + TILE_M_V2_PER_THD + 48], C[idx + 48], C[idx + TILE_M_V2_PER_THD + 48]);
    }
