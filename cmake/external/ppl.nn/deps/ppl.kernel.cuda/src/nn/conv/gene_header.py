...
def main():
    ...
    tail_pwd = sys.argv[2]
    choses_pwd = sys.argv[3]

    with open(tail_pwd + "/gene_header.cc", "w+", encoding='UTF-8') as f:
        write_head(f)

        init_include_file(f, sourse_pwd, "/2spk/fp16/async_macros.h")
        init_include_file(f, choses_pwd, "/2spk/fp16/const_macros.h")
        init_include_file(f, choses_pwd, "/2spk/fp16/hmma_macros.h")
        init_include_file(f, choses_pwd, "/2spk/fp16/ldsm_macros.h")
        init_include_file(f, sourse_pwd, "/2spk/fp16/main_body16816.h")
        init_include_file(f, choses_pwd, "/2spk/fp16/main_body1688.h")
        init_include_file(f, sourse_pwd, "/2spk/fp16/output_macros.h")
        init_include_file(f, sourse_pwd, "/2spk/fp16/reduce_macros.h")
        init_include_file(f, choses_pwd, "/2spk/fp16/smem_macros.h")
        ...
        init_include_file(f, choses_pwd, "/2spk/int8/const_macros.h")
        init_include_file(f, sourse_pwd, "/2spk/int8/imma16816_macros.h")
        init_include_file(f, sourse_pwd, "/2spk/int8/imma16832_macros.h")
        init_include_file(f, choses_pwd, "/2spk/int8/imma8816_macros.h")
        init_include_file(f, choses_pwd, "/2spk/int8/ldsm_macros.h")
        init_include_file(f, sourse_pwd, "/2spk/int8/main_body16816.h")
        init_include_file(f, sourse_pwd, "/2spk/int8/main_body16832.h")
        init_include_file(f, choses_pwd, "/2spk/int8/main_body8816.h")
        init_include_file(f, choses_pwd, "/2spk/int8/output_macros.h")
        init_include_file(f, choses_pwd, "/2spk/int8/reduce_macros.h")
        init_include_file(f, choses_pwd, "/2spk/int8/smem_macros.h")
        ...
        init_include_file(f, choses_pwd, "/swzl/int8/imma8816_macros.h")
        ...
        init_include_file(f, choses_pwd, "/swzl/int8/main_body8816.h")
        init_include_file(f, choses_pwd, "/swzl/int8/output_macros.h")
        init_include_file(f, sourse_pwd, "/swzl/int8/reduce_macros.h")
        init_include_file(f, choses_pwd, "/swzl/int8/smem_macros.h")
        ...
        init_include_file(f, choses_pwd, "/idxn/fp16/const_macros.h")
        ...
        init_include_file(f, choses_pwd, "/idxn/fp16/hmma1688_i1_macros.h")
        init_include_file(f, choses_pwd, "/idxn/fp16/hmma1688_i2_macros.h")
        init_include_file(f, choses_pwd, "/idxn/fp16/hmma1688_i4_macros.h")
        init_include_file(f, choses_pwd, "/idxn/fp16/main_body.h")
        ...
        init_include_file(f, choses_pwd, "/idxn/int8/imma8816_i1_macros.h")
        init_include_file(f, choses_pwd, "/idxn/int8/imma8816_i2_macros.h")
        init_include_file(f, choses_pwd, "/idxn/int8/imma8816_i4_macros.h")
        init_include_file(f, choses_pwd, "/idxn/int8/imma8816_output_macros.h")
        init_include_file(f, choses_pwd, "/idxn/int8/main_body.h")
