    ...
    void* output)
{
    ...
    switch (output_shape->GetDataType()) {
        ...
        case ppl::common::DATATYPE_INT32:
            ppl_cukernel_range<int32_t><<<grid_size, block_size, 0, stream>>>(num_elems, (int32_t*)start, (int32_t*)delta, (int32_t*)output);
            break;
        case ppl::common::DATATYPE_INT16:
            ppl_cukernel_range<int16_t><<<grid_size, block_size, 0, stream>>>(num_elems, (int16_t*)start, (int16_t*)delta, (int16_t*)output);
            break;
        case ppl::common::DATATYPE_INT8:
            ppl_cukernel_range<int8_t><<<grid_size, block_size, 0, stream>>>(num_elems, (int8_t*)start, (int8_t*)delta, (int8_t*)output);
            break;
        case ppl::common::DATATYPE_UINT64:
            ppl_cukernel_range<uint64_t><<<grid_size, block_size, 0, stream>>>(num_elems, (uint64_t*)start, (uint64_t*)delta, (uint64_t*)output);
            break;
        case ppl::common::DATATYPE_UINT32:
            ppl_cukernel_range<uint32_t><<<grid_size, block_size, 0, stream>>>(num_elems, (uint32_t*)start, (uint32_t*)delta, (uint32_t*)output);
            break;
        case ppl::common::DATATYPE_UINT16:
            ppl_cukernel_range<uint16_t><<<grid_size, block_size, 0, stream>>>(num_elems, (uint16_t*)start, (uint16_t*)delta, (uint16_t*)output);
            break;
        case ppl::common::DATATYPE_UINT8:
            ppl_cukernel_range<uint8_t><<<grid_size, block_size, 0, stream>>>(num_elems, (uint8_t*)start, (uint8_t*)delta, (uint8_t*)output);
            break;
        default:
