...
template <typename T, class Operator, int ReduceSize, bool MultiBlock, int ReduceMode, int ReduceVersion, int ReduceType, bool USE_4X>
    ...
    ReduceParam param)
{
    if (ReduceMode == 1) {
        ...
        ppl_reduce_rows<T, Operator, ReduceSize, MultiBlock, ReduceVersion, ReduceType, USE_4X>(op, des, param);
        return;
