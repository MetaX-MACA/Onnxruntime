...
RetCode ReshapeSplitActivation(InputOutputInfo* info, const ir::Attr*) {
    if ((info->GetInputCount() != 1 && info->GetInputCount() != 2) || info->GetOutputCount() != 1) {
    ...
    out_dims[out_dim_count - 1] = out_dims[out_dim_count - 1] / 2;
