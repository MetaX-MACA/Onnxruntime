...
RetCode BufferedCudaDevice::Init(int device_id, uint32_t mm_policy,  void* external_stream_queue) {
    auto status = CudaDevice::Init(device_id,external_stream_queue);
