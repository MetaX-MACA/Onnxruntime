...
ppl::common::RetCode MishKernel::DoExecute(KernelExecContext* ctx) {
    ...
    ppl::common::RetCode status = PPLCUDAUnaryMishForwardImp(GetStream(), input->GetShape(), input->GetBufferPtr(),
