...
#include "ppl/nn/engines/cuda/optimizer/algos/algo_pad.h"

using namespace ppl::common;

namespace ppl { namespace nn { namespace cuda {

double PadAlgorithm::ExcuteTimer(const ir::Node* node, OptKernelOptions& options) {
...
void PadAlgorithm::ReshapeOnEdges(const ir::Node* node, std::map<edgeid_t, std::unique_ptr<TensorImpl>>* tensors,
