...
#ifndef _ST_HPC_PPL_NN_ENGINES_CUDA_OPTIMIZER_FUSIONS_FS_ADD_LAYERNORM_H_
#define _ST_HPC_PPL_NN_ENGINES_CUDA_OPTIMIZER_FUSIONS_FS_ADD_LAYERNORM_H_

#include "ppl/nn/engines/cuda/optimizer/fusions/maca_fusion.h"

namespace ppl { namespace nn { namespace cuda {

class AddLayerNormFusion : public MacaFusion {

public:
    AddLayerNormFusion(){
        fusion_tree_.node_types = {"Add", "LayerNorm"};
        fusion_tree_.connect_infos = {{0,1}};
        fusion_type_ = "FusedAddLayerNorm";
    };
