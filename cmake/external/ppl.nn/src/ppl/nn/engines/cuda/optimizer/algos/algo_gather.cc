...
#include "ppl/nn/engines/cuda/optimizer/algos/algo_gather.h"

using namespace ppl::common;

namespace ppl { namespace nn { namespace cuda {

double GatherAlgorithm::ExcuteTimer(const ir::Node* node, OptKernelOptions& options) {
...
void GatherAlgorithm::ReshapeOnEdges(const ir::Node* node, std::map<edgeid_t, std::unique_ptr<TensorImpl>>* tensors,
