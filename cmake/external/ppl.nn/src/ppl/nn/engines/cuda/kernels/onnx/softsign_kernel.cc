...
ppl::common::RetCode SoftsignKernel::DoExecute(KernelExecContext* ctx) {
    ...
    ppl::common::RetCode status = PPLCUDAUnarySoftsignForwardImp(GetStream(), input->GetShape(), input->GetBufferPtr(),
