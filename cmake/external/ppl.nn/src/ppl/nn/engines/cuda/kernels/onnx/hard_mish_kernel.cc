...
ppl::common::RetCode HardMishKernel::DoExecute(KernelExecContext* ctx) {
    ...
    ppl::common::RetCode status = PPLCUDAUnaryHardMishForwardImp(GetStream(), input->GetShape(), input->GetBufferPtr(),
