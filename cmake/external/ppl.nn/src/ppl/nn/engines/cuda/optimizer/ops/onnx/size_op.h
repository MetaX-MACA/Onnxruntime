...
#ifndef _ST_HPC_PPL_NN_ENGINES_CUDA_OPTIMIZER_OPS_ONNX_SIZE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_CUDA_OPTIMIZER_OPS_ONNX_SIZE_OP_H_
...
class SizeOp final : public CudaOptKernel {
public:
    SizeOp(const ir::Node* node);
