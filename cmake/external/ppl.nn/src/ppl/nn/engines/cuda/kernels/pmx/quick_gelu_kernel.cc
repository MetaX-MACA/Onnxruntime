...
// TODO: Add operator implementation
#include "cudakernel/nn/quickgelu.h"


namespace ppl { namespace nn { namespace cuda {

ppl::common::RetCode QuickGeluKernel::DoExecute(KernelExecContext* ctx) {
    ...
    // TODO: Add operator implementation
    ppl::common::RetCode status = PPLCUDAQuickGeluForwardImp(GetStream(), input->GetShape(), input->GetBufferPtr(),
                                                                output->GetShape(), output->GetBufferPtr(), alpha, &qparam);
    return status;
}
