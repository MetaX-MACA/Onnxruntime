...
#ifdef PPLNN_USE_DNN
//#include "ppl/nn/engines/cuda/cudnn_inc/cudnn.h"
#include <cudnn.h>
#ifdef PPLNN_USE_MACA
#include <mcblasLt.h>//#include <cublasLt.h>
...
public:
    ...
    ppl::common::RetCode Init(int device_id, void* external_stream = nullptr);
    ...
    void* GetContextStream() override {
        if(stream_){
...
#ifdef PPLNN_USE_MACA
    mcblasLtHandle_t GetMcblasLtHandle() const {
        return mcblaslt_handle_;
    }
#endif//PPLNN_USE_MACA
#endif
...
#ifdef PPLNN_USE_MACA
    mcblasLtHandle_t mcblaslt_handle_ = nullptr;
#endif//PPLNN_USE_MACA
#endif
