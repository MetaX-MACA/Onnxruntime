...
if(onnxruntime_USE_PPL)
  list(APPEND onnxruntime_test_providers_dependencies onnxruntime_providers_maca)
endif()
...
if(onnxruntime_USE_PPL)
  list(APPEND onnxruntime_test_framework_libs onnxruntime_providers_maca)
  list(APPEND onnxruntime_test_providers_dependencies onnxruntime_providers_maca)
  list(APPEND onnxruntime_test_providers_libs onnxruntime_providers_maca)
endif()
...
if (onnxruntime_USE_PPL)
  ...
  target_link_libraries(onnxruntime_test_all PRIVATE
    pplnn_static
  )
  # target_link_directories(onnxruntime_test_all PRIVATE
  #       ${PPLNN_LINK_DIRS}
  #       ${CMAKE_CUDA_HOST_IMPLICIT_LINK_DIRECTORIES}
  # )
  
if(onnxruntime_USE_MACA)
file(GLOB_RECURSE onnxruntime_maca_test_src CONFIGURE_DEPENDS
  "${TEST_SRC_DIR}/providers/maca/maca_test.cc"
  "${TEST_SRC_DIR}/providers/maca/common/common.cc"
  )
onnxruntime_add_executable(maca_test ${onnxruntime_maca_test_src} )
set_target_properties(maca_test PROPERTIES COMPILE_FLAGS "-fno-strict-aliasing -Wno-error=comment -Wno-comment")
target_include_directories(maca_test PRIVATE ${TEST_SRC_DIR}/providers/maca/common)
onnxruntime_add_include_to_target(maca_test onnxruntime_session)
target_link_libraries(maca_test PRIVATE onnxruntime -lpthread -lstdc++fs)
endif()
