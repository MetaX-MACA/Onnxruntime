...
if (onnxruntime_USE_PPL)
  ...
  target_link_libraries(onnxruntime_pybind11_state PRIVATE pplnn_static)
  # target_link_directories(onnxruntime_pybind11_state PRIVATE
  #         ${PPLNN_LINK_DIRS}
  #         ${CMAKE_CUDA_HOST_IMPLICIT_LINK_DIRECTORIES}
  #   )
  # set_target_properties(onnxruntime_pybind11_state PROPERTIES
  #     INTERFACE_LINK_LIBRARIES "cuda;cudart_static;dl;rt")
  add_custom_command(
    TARGET onnxruntime_pybind11_state POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy
        $<TARGET_FILE:onnxruntime_providers_maca>
        $<TARGET_FILE:onnxruntime_providers_shared>
        $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/capi/
  )
endif()
